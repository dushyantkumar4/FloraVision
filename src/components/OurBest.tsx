...
const OurBest: React.FC = () => {
  return (
    <div className="grid grid-cols-2 border border-[] backdrop-blur-[25px] rounded-4xl p-5">
      {/* left section  */}
      <img src="src\assets\flore_img_1.png" alt="" className="size-[19rem]" />
      {/* right section  */}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            <img
              ...
              alt=""
              className="size-6 opacity-35 rotate-180"
            />
            <span className="flex items-center">
              <span className="text-[#FFFFFFBF] font-bold text-[1.25rem]">
                01/
              </span>
              <span className="text-[#FFFFFFBF] font-bold text-base">04</span>
            </span>
            <img
              src="src\assets\right_move.png"
              alt=""
